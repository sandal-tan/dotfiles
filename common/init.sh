...
if [ "$(pyenv global)" != "${PYTHON_VERSION}" ]; then
   ...
   CONFIUGRE_OPTS="--with-openssl=$(brew --prefix openssl)" \
	   CFLAGS="-I$(brew --prefix zlib)/include -I$(brew --prefix sqlite)/include -I$(brew --prefix openssl)/include"\
	   CPPFLAGS="-I$(brew --prefix zlib)/include -I$(brew --prefix sqlite)/include -I$(brew --prefix openssl)/include" \
	   LDFLAGS="-L$(brew --prefix zlib)/lib -L$(brew --prefix sqlite)/lib -L$(brew --prefix openssl)/lib" \
